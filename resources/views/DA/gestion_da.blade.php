    ...
    <div class="row">
        ...
        @endif
            ...
            @if(isset($da))
                ...
                <form role="form" id="FormRegister" class="form-inline" method="post" action="{{route('modifier_da')}}">
                    @else
                        <form role="form" id="FormRegister" class="form-inline" method="post" action="{{route('Validdas')}}">
                            @endif
                            <div class="col-sm-12">
