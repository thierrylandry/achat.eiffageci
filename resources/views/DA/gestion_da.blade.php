...
@endsection
@section('content')
    <h2>LES DEMANDES D'APPROVISIONNEMENT - {{isset($da)? 'MODIFIER ':'AJOUTER '}}</h2>
    <div class="row">
                <div class="col-sm-4">
@if(isset($da))

                            <form role="form" id="FormRegister" class="bucket-form" method="post" action="{{route('modifier_da')}}">
    @else
                                    <form role="form" id="FormRegister" class="bucket-form" method="post" action="{{route('Validdas')}}">
    @endif


                        @csrf<div class="form-group">
                                            <b><label for="libelle" class="control-label">Produit et service</label></b>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="id_nature" name="id_nature" data-live-search="true" data-size="6">
                        ...
                        @if(isset($da))
                            <a  href="{{route('gestion_da')}}">Ajouter une demande d'approvisionnement</a>
                            @endif
