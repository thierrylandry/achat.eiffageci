...
<head>
    ...
    <link href={{ URL::asset('css/bootstrap.min.css') }}"css/font-awesome.css" rel="stylesheet">
...
<section id="container">
    ...
    <section id="main-content">
        ...
        <p>{{ Auth::user()->name }} est un boss</p>
        @yield('test')
...
<script src="{{ URL::asset('js/jquery.dcjqaccordion.2.7.js') }}js/jquery.scrollTo.js"></script>
<!-- morris JavaScript -->
<script>
