...
class ligne_bc extends Model
{
    ...
    protected $fillable= ['codeRubrique','remise_ligne_bc','quantite_ligne_bc','unite_ligne_bc','prix_unitaire_ligne_bc','remise_ligne_bc','id_reponse_fournisseur','id_bonCommande'];
}
